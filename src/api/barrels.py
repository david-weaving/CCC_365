...
def get_wholesale_purchase_plan(wholesale_catalog: list[Barrel]):
    ...
    for barrel in wholesale_catalog:
        ...
        if barrel.potion_type[1] == 1 and barrel.ml_per_barrel == 200 and red_pots < 10 and barrel.price <= gold:
        ...
        quantity=0
        if barrel.potion_type[0] == 1 and barrel.ml_per_barrel == 200 and green_pots < 10 and barrel.price <= gold:
